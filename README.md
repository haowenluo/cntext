...
[pepy网站](https://www.pepy.tech/projects/cntext) 统计，截止 2025-9-12, 累积下载量  79,350 。 目前分为

- 公开cntext1.x ， 免费， 已更新至1.9.2；。
- 非公开cntext2.x， 付费，已更新至2.1.7。 感兴趣的可以点击阅读[博客: 文本分析库cntext2.x使用手册](https://textdata.cn/blog/2024-04-27-cntext2x-usage-tutorial/)
